...
end_factor_z_unit_vector = rot_trans * [0;0;1]
% quiver3([end_factor_starting_points(1) end_factor_starting_points(1) end_factor_starting_points(1)], ...
%         [end_factor_starting_points(2) end_factor_starting_points(2) end_factor_starting_points(2)],...
%         [end_factor_starting_points(3) end_factor_starting_points(3) end_factor_starting_points(3)],...
%         [end_factor_x_unit_vector(1) end_factor_y_unit_vector(1) end_factor_z_unit_vector(1)],...
%         [end_factor_x_unit_vector(2) end_factor_y_unit_vector(2) end_factor_z_unit_vector(2)],...
%         [end_factor_x_unit_vector(3) end_factor_y_unit_vector(3) end_factor_z_unit_vector(3)]);
